...
const FooterMiddleRow = () => {
    const uniAbbrList = [
        { uniId: 1, uniName: 'uoa', uniHref: 'https://www.auckland.ac.nz/' },
    ...
    return (
        <div className='FooterMiddleRow'>
            ...
            <div className='row'>
                ...
                <h6 className='col-12 cs_footer_slogan'>We work with students from universities of NZ. Get in touch with us.</h6>
            </div>
