...
import { TextField, Select as Selection, OutlinedInput, MenuItem, InputLabel, FormControl } from '@material-ui/core';
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body cs_tm_input">
                                ...
                                <div className='row'>
                                    ...
                                    />
                                    <FormControl variant="outlined" className='col-4 cs_tm_input_item'>
                                ...
                                <div className='row cs_tm_rate_group'>
                                    <div className='col-2 cs_tm_rate_label'>
                                        Rating:
                                        </div>
                                    <div className='col-1'>
                                    ...
                                    <div className='col-4 cs_tm_rate'>
                                        <Rating className='cs_tm_rate_star' value={this.state.rate} precision={1}
                                            onChange={(e, newValue) => {
                                                return (
                                ...
                                <div className='row'>
                                    <textarea name="" id=""  rows="6" className='cs_tm_comment_area'></textarea>
                                </div>
